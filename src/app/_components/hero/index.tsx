...
export function Hero() {
  ...
  const [eventTimestamp, setEventTimestamp] = useState("2025-01-01T00:00:00.000Z");
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center pt-24 overflow-hidden">
      <canvas ref={canvasRef} className="absolute inset-0 z-0 pointer-events-none select-none opacity-45" />
      ...
      <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          >
            A high-fidelity observability console demonstrating transactional outbox execution, event deduplication, and
            choreography saga workflows across 5 isolated contexts.
          </motion.p>
